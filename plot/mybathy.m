...
% and smooth) so again use this function. When visualising in 3D it is
% often difficult to revolve and rotate the entire mesh. Use the optional input bounds to
% trim out the areas you are not concerned with.
%
% h = mybathy(ax,resfil,varargin)
%
% inputs
